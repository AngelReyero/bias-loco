...
palette = {
    ...
    'LOCO_sqrt': 'red',
    'LOCO_n2': 'red',
    'Sobol-CPI(100)_0': 'cyan',
    'Sobol-CPI(100)_sqrt': 'cyan',
    'Sobol-CPI(100)_n': 'cyan',
    'Sobol-CPI(100)_n2': 'cyan',
    'Sobol-CPI(10)_bt_n': 'purple',
    'Sobol-CPI(1)_bt_n': 'blue',
    'LOCO_bt_n': 'red',
    'Sobol-CPI(100)_bt_n': 'cyan',
    'HRT': 'brown'
...
dashes = {
    'Sobol-CPI(10)_0':  (3, 5, 1, 5),
    'Sobol-CPI(10)_sqrt': (5, 5),
    'Sobol-CPI(10)_n': (1, 1),
    'Sobol-CPI(10)_bt_n': (3, 1, 3),
    'Sobol-CPI(10)_n2': (2, 4),
    
    'Sobol-CPI(1)_0':  (3, 5, 1, 5),
    'Sobol-CPI(1)_sqrt': (5, 5),
    'Sobol-CPI(1)_n': (1, 1),
    'Sobol-CPI(1)_bt_n': (3, 1, 3),
    'Sobol-CPI(1)_n2': (2, 4),
    
    'Sobol-CPI(100)_0':  (3, 5, 1, 5),
    'Sobol-CPI(100)_sqrt': (5, 5),
    'Sobol-CPI(100)_n': (1, 1),
    'Sobol-CPI(100)_bt_n': (3, 1, 3),
...
df['method'] = df['method'].replace('CPI', 'Sobol-CPI(1)_0')
df['method'] = df['method'].replace('R-CPI', 'Sobol-CPI(10)_0')
df['method'] = df['method'].replace('R-CPI2', 'Sobol-CPI(100)_0')
df['method'] = df['method'].replace('CPI_n', 'Sobol-CPI(1)_n_2')
df['method'] = df['method'].replace('R-CPI_n', 'Sobol-CPI(10)_n_2')
df['method'] = df['method'].replace('R-CPI2_n', 'Sobol-CPI(100)_n_2')
...
df['method'] = df['method'].replace('LOCO_n', 'LOCO_n_2')
