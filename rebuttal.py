...
df['method'] = df['method'].replace('CPI_bt', 'Sobol-CPI(1)_n')
df['method'] = df['method'].replace('R-CPI_bt', 'Sobol-CPI(10)_n')
df['method'] = df['method'].replace('R-CPI2_bt', 'Sobol-CPI(100)_n')
...
df['method'] = df['method'].replace('LOCO_n', 'LOCO_bt2')
df['method'] = df['method'].replace('LOCO_bt', 'LOCO_n')
...
methods_to_plot = ['Sobol-CPI(1)_n', 'LOCO-W', 'HRT'] 
...
methods_to_plot = [ 'Sobol-CPI(10)_n', 'LOCO-W', 'HRT' ]
filtered_df = df[df['method'].isin(methods_to_plot)]
...
methods_to_plot = [ 'Sobol-CPI(100)_n', 'LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
...
methods_to_plot = ['LOCO_n', 'LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
...
plt.savefig(f"final_figures/appendix/rebuttal_power_{method}_p{p}_cor{cor}.pdf", bbox_inches="tight")
...
fig.text(0.05, 0.45, 'Type-I error', ha='center', fontsize=20, rotation=90)


plt.savefig(f"final_figures/appendix/rebuttal_type_{method}_p{p}_cor{cor}.pdf", bbox_inches="tight")



sns.set_style("white")
fig_time, ax_time = plt.subplots(1, 2, figsize=(12, 5), gridspec_kw={'hspace': 0.15, 'wspace': 0.2})

methods_to_plot = ['Sobol-CPI(1)_n','Sobol-CPI(10)_n','Sobol-CPI(100)_n', 'LOCO_n', 'LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df, x='n', y='tr_time', hue='method', palette=palette, markers=markers, dashes=dashes, style='method',ax=ax_time[0])  # Top-left subplot

# Format top-left subplot
ax_time[0].set_xscale('log')
ax_time[0].set_yscale('log')

ax_time[0].tick_params(axis='x', labelsize=15)  # Adjust x-axis tick label font size
ax_time[0].tick_params(axis='y', labelsize=15) 
ax_time[0].set_xlabel(r'')
ax_time[0].set_ylabel(f'', fontsize=20)
ax_time[0].set_title('Linear setting', fontsize=22) 
...
methods_to_plot = ['Sobol-CPI(1)_sqrt','Sobol-CPI(10)_sqrt','Sobol-CPI(100)_sqrt', 'LOCO_sqrt', 'LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df, x='n', y='tr_time', hue='method', palette=palette, markers=markers, dashes=dashes, style='method',ax=ax_time[1])  # Top-left subplot

# Format top-left subplot
ax_time[1].set_xscale('log')
ax_time[1].set_yscale('log')

ax_time[1].tick_params(axis='x', labelsize=15)  # Adjust x-axis tick label font size
ax_time[1].tick_params(axis='y', labelsize=15) 
ax_time[1].set_xlabel(r'')
ax_time[1].set_ylabel(f'', fontsize=20)
ax_time[1].set_title('Polynomial setting', fontsize=22) 
fig_time.text(0.5, -0.05, 'Number of samples', ha='center', fontsize=20)

fig_time.text(0.05, 0.45, 'Time', ha='center', fontsize=20, rotation=90)


plt.savefig(f"final_figures/appendix/rebuttal_time.pdf", bbox_inches="tight")
...
methods_to_plot = ['Sobol-CPI(1)_sqrt','LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df, x='n', y='power', hue='method', palette=palette, markers=markers, dashes=dashes, style='method',ax=ax[0, 0])  # Top-left subplot
...
methods_to_plot = ['Sobol-CPI(10)_sqrt', 'LOCO-W', 'HRT' ]
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df, x='n', y='power', hue='method', palette=palette, ax=ax[0, 1], markers=markers,dashes=dashes, style='method')  # Top-left subplot
...
methods_to_plot = ['Sobol-CPI(100)_sqrt', 'LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df, x='n', y='power', hue='method', palette=palette, ax=ax[1, 0], markers=markers, dashes=dashes, style='method')  # Top-left subplot
...
methods_to_plot = [ 'LOCO_sqrt', 'LOCO-W', 'HRT'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df, x='n', y='power', hue='method', palette=palette, ax=ax[1, 1], markers=markers, dashes=dashes, style='method')  # Top-left subplot
