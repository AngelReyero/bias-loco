...
df = pd.read_csv(f"p_values/fails_csv/williamson_sqd.csv",)
...
for index, row in df.iterrows():
    ...
    non_null.append(np.mean(abs(y_pred[y==1]-0.407)))
...
plt.savefig(f"p_values/visualization_fail/AUC.pdf", bbox_inches="tight")
...
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/null_imp.pdf", bbox_inches="tight")
...
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/non_null.pdf", bbox_inches="tight")
...
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/time.pdf", bbox_inches="tight")
...
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/power_main.pdf", bbox_inches="tight")
...
plt.ylabel(f'Power',fontsize=17 )
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/power_sqd.pdf", bbox_inches="tight")
...
plt.ylabel(f'Power',fontsize=17 )
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/power_tot.pdf", bbox_inches="tight")

plt.figure()
sns.set(rc={'figure.figsize':(4,4)})
methods_to_plot = ['Sobol-CPI(10)', 'Sobol-CPI(10)_sqrt', 'Sobol-CPI(10)_n',  'Sobol-CPI(10)_n2','Sobol-CPI(10)_bt'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df,x='n',y=f'power',hue='method',style='method',palette=palette, markers=markers, dashes=dashes)#,style='Regressor',markers=markers, dashes=dashes)
...
plt.ylabel(f'Power',fontsize=17 )
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/power_R-CPI.pdf", bbox_inches="tight")
...
plt.figure()
sns.set(rc={'figure.figsize':(4,4)})
methods_to_plot = ['Sobol-CPI(100)', 'Sobol-CPI(100)_sqrt', 'Sobol-CPI(100)_n', 'Sobol-CPI(100)_n2', 'Sobol-CPI(100)_bt'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df,x='n',y=f'power',hue='method',style='method',palette=palette, markers=markers, dashes=dashes)#,style='Regressor',markers=markers, dashes=dashes)
...
plt.ylabel(f'Power',fontsize=17 )
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/power_R-CPI2.pdf", bbox_inches="tight")

plt.figure()
sns.set(rc={'figure.figsize':(4,4)})
methods_to_plot = ['LOCO', 'LOCO_sqrt', 'LOCO_n', 'LOCO_n2','LOCO_bt'] 
filtered_df = df[df['method'].isin(methods_to_plot)]
sns.lineplot(data=filtered_df,x='n',y=f'power',hue='method',style='method',palette=palette, markers=markers, dashes=dashes)#,style='Regressor',markers=markers, dashes=dashes)
...
plt.ylabel(f'Power',fontsize=17 )
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/power-LOCO.pdf", bbox_inches="tight")
...
plt.xlabel(r'Number of samples',fontsize=17 )
plt.savefig(f"p_values/visualization_fail/type.pdf", bbox_inches="tight")
